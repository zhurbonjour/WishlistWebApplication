    ...
    if user.is_authenticated:
        ...
        if user_id:
            ...
            try:
                ...
                # вывод страницы с поиском, если у пользователя
                # нет добавленных друзей
                return render(request, 'friend/no_friends.html')
            ...
            for friend in friend_list.friends.all():
                friends.append(
                    (friend, auth_user_friend_list.is_mutual_friends(friend)))
...
def friend_requests(request, *args, **kwargs):
    ...
    if user.is_authenticated:
        ...
        redirect("login")
    return render(request, "friend/friend_request.html", context)
...
def send_friend_request(request, *args, **kwargs):
    ...
    if request.method == "POST" and user.is_authenticated:
        ...
        if user_id:
            ...
            try:
                ...
                try:
                    ...
                    friend_request = FriendRequest(sender=user,
                                                   receiver=receiver)
                    friend_request.save()
        ...
        payload[
            'response'] = "You must be authenticated to send a friend request."
...
def accept_friend_request(request, *args, **kwargs):
    ...
    if request.method == "GET" and user.is_authenticated:
        ...
        # should never happen
        payload[
            'response'] = "You must be authenticated to accept a friend request."
    return HttpResponse(json.dumps(payload), content_type="application/json")
...
def remove_friend(request, *args, **kwargs):
    ...
    if request.method == "POST" and user.is_authenticated:
        ...
        if user_id:
            ...
            payload[
                'response'] = "There was an error. Unable to remove that friend."
    else:
        # should never happen
    ...
    if request.method == "POST" and user.is_authenticated:
        ...
        if user_id:
            ...
            try:
                ...
                payload[
                    'response'] = "Nothing to cancel. Friend request does not exist."
        ...
        # should never happen
        payload[
            'response'] = "You must be authenticated to cancel a friend request."
    return HttpResponse(json.dumps(payload), content_type="application/json")
